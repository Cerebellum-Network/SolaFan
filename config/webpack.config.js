  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        config: path.resolve(paths.appPath, 'src/config'),
        shared: path.resolve(paths.appPath, 'src/shared'),
        context: path.resolve(paths.appPath, 'src/context'),
      ...
      rules: [
        ...
        {parser: {requireEnsure: false}},
        {
          ...
          oneOf: [
            ...
            /**
             * Adds `import.meta.url` support to Webpack 4 builds.
             * Needed for libs that rely on this API, eg. `@polkadot/*` packages:
